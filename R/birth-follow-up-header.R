...
ECG_ROOT    <- file.path(BOX_PATH, "Firstbeat Bodyguard 3 data/Wave 1 data/6. Birth follow up Mothers & Children")
EDA_ROOT    <- file.path(BOX_PATH, "eSense data/Wave 1 data/6. Birth follow up Mothers")
